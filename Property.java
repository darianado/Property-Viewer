...
public class Property
{
    ...
    public Property(String id, String name, String hostID, String hostName, 
            ...
            int price, int minimumNights, int availability365, int nr_views){
	this.id = id;
    ...
    /**
     * Return the number of views of this property.
     */
    ...
    /**
     * Set the number of views of this property.
     */
    public void setNrViews(int views){
        nr_views=views;
    }
